...
def QSOEID(Z, I, NoCov, T, I_0, R_0, bias_corr_const,tau_0):
    ...
    for t in range(tau_0 , T):
        ...
        EstPhi[t, :] = fmin(func=ell, x0=[0.05, 0.7], args=(t, bias_corr_const), maxiter=5000, maxfun=5000)
...
perform_estimation_and_plot(df,os.path.join(results_folder, "df"))
perform_estimation_and_plot(df1, os.path.join(results_folder, "df1"))
perform_estimation_and_plot(df2,os.path.join(results_folder, "df2"))
